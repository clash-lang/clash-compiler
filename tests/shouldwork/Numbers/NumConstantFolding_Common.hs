...
-}
module NumConstantFolding_Common where
...
-- Lift for 8-12 tuples
deriving instance
  (Lift a, Lift b, Lift c, Lift d, Lift e, Lift f, Lift g, Lift h) =>
  Lift (a, b, c, d, e, f, g, h)
deriving instance
  (Lift a, Lift b, Lift c, Lift d, Lift e, Lift f, Lift g, Lift h, Lift i) =>
  Lift (a, b, c, d, e, f, g, h, i)
deriving instance
  (Lift a, Lift b, Lift c, Lift d, Lift e, Lift f, Lift g, Lift h, Lift i, Lift j) =>
  Lift (a, b, c, d, e, f, g, h, i, j)
deriving instance
  (Lift a, Lift b, Lift c, Lift d, Lift e, Lift f, Lift g, Lift h, Lift i, Lift j, Lift k) =>
