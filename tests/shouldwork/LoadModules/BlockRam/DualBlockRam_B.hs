...
simOutA_WF_WF_F_T_AB = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut WriteFirst WriteFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutA_WF_WF_F_T_AB #-}
simOutA_WF_WF_F_T_BC = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut WriteFirst WriteFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutA_WF_WF_F_T_BC #-}
simOutA_WF_RF_F_T_AB = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut WriteFirst ReadFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutA_WF_RF_F_T_AB #-}
simOutA_WF_RF_F_T_BC = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut WriteFirst ReadFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutA_WF_RF_F_T_BC #-}
simOutA_WF_NC_F_T_AB = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut WriteFirst NoChange True True rst20 rst10 clk20 clk10))
{-# INLINE simOutA_WF_NC_F_T_AB #-}
simOutA_WF_NC_F_T_BC = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut WriteFirst NoChange True True rst10 rst7 clk10 clk7))
{-# INLINE simOutA_WF_NC_F_T_BC #-}
simOutA_RF_WF_F_T_AB = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut ReadFirst WriteFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutA_RF_WF_F_T_AB #-}
simOutA_RF_WF_F_T_BC = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut ReadFirst WriteFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutA_RF_WF_F_T_BC #-}
simOutA_RF_RF_F_T_AB = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut ReadFirst ReadFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutA_RF_RF_F_T_AB #-}
simOutA_RF_RF_F_T_BC = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut ReadFirst ReadFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutA_RF_RF_F_T_BC #-}
simOutA_RF_NC_F_T_AB = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut ReadFirst NoChange True True rst20 rst10 clk20 clk10))
{-# INLINE simOutA_RF_NC_F_T_AB #-}
simOutA_RF_NC_F_T_BC = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut ReadFirst NoChange True True rst10 rst7 clk10 clk7))
{-# INLINE simOutA_RF_NC_F_T_BC #-}
simOutA_NC_WF_F_T_AB = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut NoChange WriteFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutA_NC_WF_F_T_AB #-}
simOutA_NC_WF_F_T_BC = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut NoChange WriteFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutA_NC_WF_F_T_BC #-}
simOutA_NC_RF_F_T_AB = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut NoChange ReadFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutA_NC_RF_F_T_AB #-}
simOutA_NC_RF_F_T_BC = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut NoChange ReadFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutA_NC_RF_F_T_BC #-}
simOutA_NC_NC_F_T_AB = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut NoChange NoChange True True rst20 rst10 clk20 clk10))
{-# INLINE simOutA_NC_NC_F_T_AB #-}
simOutA_NC_NC_F_T_BC = $(collectSimResults (length opsA+1) $ pack <$> (fst $ topOut NoChange NoChange True True rst10 rst7 clk10 clk7))
{-# INLINE simOutA_NC_NC_F_T_BC #-}
simOutB_WF_WF_F_T_AB = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut WriteFirst WriteFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutB_WF_WF_F_T_AB #-}
simOutB_WF_WF_F_T_BC = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut WriteFirst WriteFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutB_WF_WF_F_T_BC #-}
simOutB_WF_RF_F_T_AB = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut WriteFirst ReadFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutB_WF_RF_F_T_AB #-}
simOutB_WF_RF_F_T_BC = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut WriteFirst ReadFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutB_WF_RF_F_T_BC #-}
simOutB_WF_NC_F_T_AB = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut WriteFirst NoChange True True rst20 rst10 clk20 clk10))
{-# INLINE simOutB_WF_NC_F_T_AB #-}
simOutB_WF_NC_F_T_BC = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut WriteFirst NoChange True True rst10 rst7 clk10 clk7))
{-# INLINE simOutB_WF_NC_F_T_BC #-}
simOutB_RF_WF_F_T_AB = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut ReadFirst WriteFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutB_RF_WF_F_T_AB #-}
simOutB_RF_WF_F_T_BC = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut ReadFirst WriteFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutB_RF_WF_F_T_BC #-}
simOutB_RF_RF_F_T_AB = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut ReadFirst ReadFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutB_RF_RF_F_T_AB #-}
simOutB_RF_RF_F_T_BC = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut ReadFirst ReadFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutB_RF_RF_F_T_BC #-}
simOutB_RF_NC_F_T_AB = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut ReadFirst NoChange True True rst20 rst10 clk20 clk10))
{-# INLINE simOutB_RF_NC_F_T_AB #-}
simOutB_RF_NC_F_T_BC = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut ReadFirst NoChange True True rst10 rst7 clk10 clk7))
{-# INLINE simOutB_RF_NC_F_T_BC #-}
simOutB_NC_WF_F_T_AB = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut NoChange WriteFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutB_NC_WF_F_T_AB #-}
simOutB_NC_WF_F_T_BC = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut NoChange WriteFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutB_NC_WF_F_T_BC #-}
simOutB_NC_RF_F_T_AB = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut NoChange ReadFirst True True rst20 rst10 clk20 clk10))
{-# INLINE simOutB_NC_RF_F_T_AB #-}
simOutB_NC_RF_F_T_BC = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut NoChange ReadFirst True True rst10 rst7 clk10 clk7))
{-# INLINE simOutB_NC_RF_F_T_BC #-}
simOutB_NC_NC_F_T_AB = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut NoChange NoChange True True rst20 rst10 clk20 clk10))
{-# INLINE simOutB_NC_NC_F_T_AB #-}
simOutB_NC_NC_F_T_BC = $(collectSimResults (length opsB+1) $ pack <$> (snd $ topOut NoChange NoChange True True rst10 rst7 clk10 clk7))
