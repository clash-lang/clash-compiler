...
--        }
    ...
    , clashTestGroup "shouldwork"
...
#endif
        , outputTest "NameInlining" allTargets [] []
        , runTest "NameInstance" def{hdlSim=False}
        , outputTest "NameInstance" allTargets [] []
        , outputTest "SetName" [VHDL] [] []
      ...
      , clashTestGroup "BlackBox"
        [ outputTest "TemplateFunction" [VHDL] [] []
        , outputTest "BlackBoxFunction" [VHDL] [] []
        , runTest "BlackBoxFunctionHO" def{hdlTargets=[VHDL]}
        , outputTest "ZeroWidth" [VHDL] [] []
        , outputTest "MultiResult" [VHDL] [] []
      ...
      , clashTestGroup "Issues" $
        ...
        , clashLibTest ("tests" </> "shouldwork" </> "Issues") [VHDL] [] "T1388"
        , outputTest "T1171" allTargets [] []
        , clashLibTest ("tests" </> "shouldwork" </> "Issues") [VHDL] [] "T1439"
        , runTest "T1477" def{hdlSim=False}
        , runTest "T1506A" def{hdlSim=False, clashFlags=["-fclash-aggressive-x-optimization-blackboxes"]}
        , outputTest "T1506B" allTargets ["-fclash-aggressive-x-optimization-blackboxes"] ["-itests/shouldwork/Issues"]
        ...
        if compiledWith == Cabal then
          ...
          [clashLibTest ("tests" </> "shouldwork" </> "Issues") allTargets [] "T1568"]
        else
          []
      ...
      , clashTestGroup "Naming"
        ...
        , clashLibTest ("tests" </> "shouldwork" </> "Naming") allTargets [] "T1041"
        , clashLibTest ("tests" </> "shouldwork" </> "Naming") [VHDL,Verilog] [] "NameHint"
        ]
      , clashTestGroup "Netlist"
          [ clashLibTest ("tests" </> "shouldwork" </> "Netlist") allTargets [] "Identity"
          , clashLibTest ("tests" </> "shouldwork" </> "Netlist") [VHDL] [] "NoDeDup"
          , clashLibTest ("tests" </> "shouldwork" </> "Netlist") allTargets [] "T1766"
          ]
      , clashTestGroup "Numbers"
        ...
        , outputTest "ExpWithClashCF" allTargets [] ["-itests/shouldwork/Numbers"]
        , let _opts = def { hdlTargets = [VHDL], hdlSim = False }
        ...
        , outputTest "NumConstantFolding_1" allTargets ["-fconstraint-solver-iterations=15"] ["-itests/shouldwork/Numbers"]
        , runTest "NumConstantFoldingTB_2" def{clashFlags=["-itests/shouldwork/Numbers"]}
        , outputTest "NumConstantFolding_2" allTargets ["-fconstraint-solver-iterations=15"] ["-itests/shouldwork/Numbers"]
        ...
        , runTest "T1351" def
        , outputTest "UndefinedConstantFolding" allTargets [] ["-itests/shouldwork/Numbers"]
      ...
      , clashTestGroup "Signal"
        ...
        , runTest "RomFile" def
        , outputTest "BlockRamLazy" allTargets [] []
        , runTest "BlockRamTest" def{hdlSim=False}
        ...
        , outputTest "T1102A" [VHDL] [] []
        , outputTest "T1102B" [VHDL] [] []
      ...
      , clashTestGroup "SynthesisAttributes"
        [ outputTest "Simple" allTargets [] []
        , outputTest "Product" allTargets [] []
        , outputTest "InstDeclAnnotations" allTargets [] []
        , runTest "Product" def
        , outputTest "T1771" allTargets [] []
        ]
      ...
      , clashTestGroup "TopEntity"
        ...
        [ outputTest "PortGeneration" allTargets [] []
        , outputTest "PortNamesWithSingletonVector" [Verilog] [] []
      ...
      , clashTestGroup "XOptimization"
        [ outputTest "Conjunction" allTargets [] []
        , outputTest "Disjunction" allTargets [] []
        , clashLibTest ("tests" </> "shouldwork" </> "XOptimization") allTargets [] "OneDefinedDataPat"
        , clashLibTest ("tests" </> "shouldwork" </> "XOptimization") allTargets [] "OneDefinedLitPat"
        , clashLibTest ("tests" </> "shouldwork" </> "XOptimization") allTargets [] "OneDefinedDefaultPat"
        , clashLibTest ("tests" </> "shouldwork" </> "XOptimization") allTargets [] "ManyDefined"
        ]
--    , clashTestGroup "PartialEvaluation"
--      [ clashLibTest ("tests" </> "shouldwork" </> "PartialEvaluation") allTargets [] "EtaExpansion"
--      , clashLibTest ("tests" </> "shouldwork" </> "PartialEvaluation") allTargets [] "KnownCase"
--      , clashLibTest ("tests" </> "shouldwork" </> "PartialEvaluation") allTargets [] "CaseOfCase"
--      , clashLibTest ("tests" </> "shouldwork" </> "PartialEvaluation") allTargets [] "LazyEvaluation"
--      , clashLibTest ("tests" </> "shouldwork" </> "PartialEvaluation") allTargets [] "MutualRecursion"
--      ]
      ] -- end shouldwork
    ] -- end tests
  ] -- end .
