...
--        }
    ...
    , clashTestGroup "shouldwork"
      ...
      , clashTestGroup "Issues" $
        ...
        , clashLibTest "T1388" [VHDL] []
        , outputTest "T1171" allTargets [] []
        , clashLibTest "T1439" [VHDL] []
      ...
      , clashTestGroup "Naming"
        ...
        , clashLibTest "T1041" allTargets []
        , clashLibTest "NameHint" [VHDL,Verilog] []
        ]
      , clashTestGroup "Netlist"
          [ clashLibTest "Identity" allTargets []
          , clashLibTest "NoDeDup" [VHDL] []
          , clashLibTest "T1766" allTargets []
          ]
      ...
      , clashTestGroup "TopEntity"
        ...
        , clashLibTest "T1182A" allTargets []
        , clashLibTest "T1182B" allTargets []
        ]
      , clashTestGroup "Unit"
        [ runTest "Imap" def
      ...
      , clashTestGroup "XOptimization"
        ...
        , clashLibTest "OneDefinedDataPat" allTargets []
        , clashLibTest "OneDefinedLitPat" allTargets []
        , clashLibTest "OneDefinedDefaultPat" allTargets []
        , clashLibTest "ManyDefined" allTargets []
        ]
--    , clashTestGroup "PartialEvaluation"
--      [ clashLibTest "EtaExpansion" allTargets []
--      , clashLibTest "KnownCase" allTargets []
--      , clashLibTest "CaseOfCase" allTargets []
--      , clashLibTest "LazyEvaluation" allTargets []
--      , clashLibTest "MutualRecursion" allTargets []
--      ]
      ] -- end shouldwork
    ] -- end tests
  ] -- end .
