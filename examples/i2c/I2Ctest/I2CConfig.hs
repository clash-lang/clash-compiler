...
{-# ANN
  config
  Synthesize{t_name = "configi2c", t_inputs = [], t_output = PortName ""}
  #-}
config ::
  Clock System ->
  Signal System ConfI ->
