...
import Test.Tasty.SmallCheck (Property, Reason, Testable, monadic, test)

import Clash.Prelude (Bit, BitSize, SNat (..), Signed, snatToNum)
...
data SomeObjectType
  = forall a.
    (TShow a, IsObject a, Coercible Object a, NFData a) =>
