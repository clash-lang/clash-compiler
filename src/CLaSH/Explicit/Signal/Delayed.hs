...
-- @
--
-- >>> sampleN 6 (delay3 (systemClock (pure True)) systemReset (dfromList [1..]))
-- [0,0,0,1,2,3]
delayed
...
-- @
--
-- >>> sampleN 6 (delay2 (systemClock (pure True)) systemReset (dfromList [1..]))
-- [0,0,1,2,3,4]
delayedI
...
-- @
--
-- >>> sampleN 6 (mac (systemClock (pure True)) systemReset (dfromList [1..]) (dfromList [1..]))
-- [0,1,5,14,30,55]
feedback
