...
-- decodeFloat_Int# :: Float# -> (#Int#, Int##)
...
#if !MIN_VERSION_base(4,15,0)
  $(namePat 'GHC.Integer.Type.smallInteger)
    | [Lit (IntLiteral i)] <- args
...
#else
  $(namePat 'GHC.Integer.Type.integerToInt)
#endif
...
#else
  $(namePat 'GHC.Integer.Type.decodeDoubleInteger) -- :: Double# -> (#Integer, Int##)
#endif
...
#else
  $(namePat 'GHC.Integer.Type.encodeDoubleInteger) -- :: Integer -> Int# -> Double
#endif
...
#else
  $(namePat 'GHC.Integer.Type.quotRemInteger) -- :: Integer -> Integer -> (#Integer, Integer#)
#endif
...
#else
  $(namePat 'GHC.Integer.Type.plusInteger)
#endif
...
#else
  $(namePat 'GHC.Integer.Type.minusInteger)
#endif
    | Just (i,j) <- integerLiterals args
    -> reduce (integerToIntegerLiteral (i-j))
...
#else
  $(namePat 'GHC.Integer.Type.timesInteger)
#endif
    | Just (i,j) <- integerLiterals args
    -> reduce (integerToIntegerLiteral (i*j))
...
#else
  $(namePat 'GHC.Integer.Type.negateInteger)
#endif
    | [i] <- integerLiterals' args
...
#else
  $(namePat 'GHC.Integer.Type.divInteger)
#endif
    | Just (i,j) <- integerLiterals args
...
#else
  $(namePat 'GHC.Integer.Type.modInteger)
#endif
    | Just (i,j) <- integerLiterals args
...
#else
  $(namePat 'GHC.Integer.Type.quotInteger)
#endif
    | Just (i,j) <- integerLiterals args
...
#else
  $(namePat 'GHC.Integer.Type.remInteger)
#endif
    | Just (i,j) <- integerLiterals args
...
#else
  $(namePat 'GHC.Integer.Type.divModInteger)
#endif
    | Just (i,j) <- integerLiterals args
...
#else
  $(namePat 'GHC.Integer.Type.gtInteger)
#endif
    | Just (i,j) <- integerLiterals args
    -> reduce (boolToBoolLiteral tcm ty (i > j))
...
#else
  $(namePat 'GHC.Integer.Type.geInteger)
#endif
    | Just (i,j) <- integerLiterals args
    -> reduce (boolToBoolLiteral tcm ty (i >= j))
...
#else
  $(namePat 'GHC.Integer.Type.eqInteger)
#endif
    | Just (i,j) <- integerLiterals args
    -> reduce (boolToBoolLiteral tcm ty (i == j))
...
#else
  $(namePat 'GHC.Integer.Type.neqInteger)
#endif
    | Just (i,j) <- integerLiterals args
    -> reduce (boolToBoolLiteral tcm ty (i /= j))
...
#else
  $(namePat 'GHC.Integer.Type.ltInteger)
#endif
    | Just (i,j) <- integerLiterals args
    -> reduce (boolToBoolLiteral tcm ty (i < j))
...
#else
  $(namePat 'GHC.Integer.Type.leInteger)
#endif
    | Just (i,j) <- integerLiterals args
    -> reduce (boolToBoolLiteral tcm ty (i <= j))
...
#else
  $(namePat 'GHC.Integer.Type.compareInteger) -- :: Integer -> Integer -> Ordering
#endif
    | [i, j] <- integerLiterals' args
...
#else
  $(namePat 'GHC.Integer.Type.shiftRInteger)
    | [iV, Lit (IntLiteral j)] <- args
#endif
    , [i] <- integerLiterals' [iV]
  ...
  $(namePat 'GHC.Num.Integer.integerShiftL#)
    | [iV, Lit (WordLiteral j)] <- args
#else
  $(namePat 'GHC.Integer.Type.shiftLInteger)
    | [iV, Lit (IntLiteral j)] <- args
#endif
    , [i] <- integerLiterals' [iV]
...
#else
  $(namePat 'GHC.Integer.Type.wordToInteger)
#endif
...
#else
  $(namePat 'GHC.Integer.Type.integerToWord)
#endif
    | [i] <- integerLiterals' args
...
#else
  $(namePat 'GHC.Integer.Type.testBitInteger) -- :: Integer -> Int# -> Bool
  ...
  $(namePat 'GHC.Natural.$wshiftLNatural)
    | [nV,iV] <- args
  ...
  $(namePat 'GHC.Num.Integer.integerSignum)
#else
  $(namePat 'GHC.Integer.Type.signumInteger)
#endif
    | [i] <- integerLiterals' args
...
#else
  $(namePat 'GHC.Integer.Type.absInteger)
#endif
    | [i] <- integerLiterals' args
  ...
  $(namePat 'GHC.Num.Integer.integerBit#)
    | [i] <- wordLiterals' args
#else
  $(namePat 'GHC.Integer.Type.bitInteger)
    | [i] <- intLiterals' args
#endif
...
#else
  $(namePat 'GHC.Integer.Type.complementInteger)
#endif
    | [i] <- integerLiterals' args
...
#else
  $(namePat 'GHC.Integer.Type.orInteger)
#endif
    | [i, j] <- integerLiterals' args
...
#else
  $(namePat 'GHC.Integer.Type.xorInteger)
#endif
    | [i, j] <- integerLiterals' args
...
#else
  $(namePat 'GHC.Integer.Type.andInteger)
#endif
    | [i, j] <- integerLiterals' args
...
-- Indexing
  $(namePat 'Clash.Sized.Vector.index_int) -- :: KnownNat n => Vec n a -> Int
    | nTy : aTy : _  <- tys
    , _ : xs : i : _ <- args
...
-- Modifying vectors
  $(namePat 'Clash.Sized.Vector.replace_int) -- :: KnownNat n => Vec n a -> Int -> a -> Vec n a
    | nTy : aTy : _  <- tys
    , _ : xs : i : a : _ <- args
    , DC intDc [Left (Literal (IntLiteral i'))] <- i
    -> if i' < 0
