...
ghcPrimUnwind tcm p tys vs v [] m
  | primName p
      `elem` [ showt 'Clash.Sized.Internal.Index.fromInteger#,
...
ghcPrimUnwind tcm p tys vs v [e] m0
  ...
  | primName p
      `elem` [ showt 'Clash.Sized.Vector.lazyV,
