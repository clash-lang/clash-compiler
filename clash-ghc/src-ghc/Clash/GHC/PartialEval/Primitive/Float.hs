...
module Clash.GHC.PartialEval.Primitive.Float
  ( floatPrims
  ) where
...
floatPrims = HashMap.fromList
  ...
  , ("GHC.Prim.divideFloat#", liftBinary# divideFloat#)
  ...
  , ("GHC.Prim.logFloat#", liftUnary# logFloat#)
  ...
  , ("GHC.Prim.asinFloat#", liftUnary# asinFloat#)
  , ("GHC.Prim.acosFloat#", liftUnary# acosFloat#)
