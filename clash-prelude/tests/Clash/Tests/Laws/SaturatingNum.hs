...
saturatingNumLaws testEnum genA =
  ( if testEnum
      then
        ...
        , testCase
            "SatSymmetric: Become maxBound on overflow"
            (satSymmetricOverflow genA)
        , testCase
            "SatSymmetric: Become minBound or minBound+1 on underflow"
            (satSymmetricUnderflow genA)
        , testCase
            "SatBound: Become maxBound on overflow"
            (satBoundOverflowLaw genA)
        , testCase
            "SatBound: Become minBound on underflow"
