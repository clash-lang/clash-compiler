...
-- Tests for maybeNumConvertThrough (conversions that can fail)

case_throughMaybeInt64Word64 :: Assertion
case_throughMaybeInt64Word64 = do
  -- Successful conversions (non-negative values)
  assertBool "0" $ maybeNumConvertThrough (0 :: Int64) == Just (0 :: Word64)
  assertBool "1" $ maybeNumConvertThrough (1 :: Int64) == Just (1 :: Word64)
  assertBool "42" $ maybeNumConvertThrough (42 :: Int64) == Just (42 :: Word64)
  assertBool "maxBound" $ maybeNumConvertThrough (maxBound :: Int64) == Just (9223372036854775807 :: Word64)
  -- Failed conversions (negative values)
  assertBool "-1" $ maybeNumConvertThrough (-1 :: Int64) == (Nothing :: Maybe Word64)
  assertBool "-42" $ maybeNumConvertThrough (-42 :: Int64) == (Nothing :: Maybe Word64)
  assertBool "minBound" $ maybeNumConvertThrough (minBound :: Int64) == (Nothing :: Maybe Word64)

case_throughMaybeWord64Unsigned32 :: Assertion
case_throughMaybeWord64Unsigned32 = do
  -- Successful conversions (small values)
  assertBool "0" $ maybeNumConvertThrough (0 :: Word64) == Just (0 :: Unsigned 32)
  assertBool "1" $ maybeNumConvertThrough (1 :: Word64) == Just (1 :: Unsigned 32)
  assertBool "42" $ maybeNumConvertThrough (42 :: Word64) == Just (42 :: Unsigned 32)
  assertBool "maxBound32" $ maybeNumConvertThrough (4294967295 :: Word64) == Just (maxBound :: Unsigned 32)
  -- Failed conversions (values too large)
  assertBool "overflow1" $ maybeNumConvertThrough (4294967296 :: Word64) == (Nothing :: Maybe (Unsigned 32))
  assertBool "overflow2" $ maybeNumConvertThrough (5000000000 :: Word64) == (Nothing :: Maybe (Unsigned 32))
  assertBool "maxBound64" $ maybeNumConvertThrough (maxBound :: Word64) == (Nothing :: Maybe (Unsigned 32))
