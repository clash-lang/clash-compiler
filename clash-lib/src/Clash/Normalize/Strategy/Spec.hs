...
-- 'Clash.Normalize.Strategy.constantPropagation' binding; the splice site
-- passes it because this module cannot quote that name itself — Template
-- Haskell cannot link a spec module that (SOURCE-)imports the module being
-- spliced into.
